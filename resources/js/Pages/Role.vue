              ...
              <table class="min-w-full">
                <thead>
                  <tr>
                    ...
                    <th class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Role ID</th>
                  </tr>
                </thead>
                <tbody>
                  <tr v-for="user in users" :key="user.id">
                    ...
                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ user.role_id }}</td>
                  </tr>
                </tbody>
              </table>
            </div>

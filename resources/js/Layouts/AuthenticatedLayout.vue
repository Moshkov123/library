                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('qrcode')" :active="route().current('qrcode')">
                                    Qr кода
                                </NavLink>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('editor.index')" :active="route().current('editor.index')">
                                    Редактор Книги
                                </NavLink>
                            </div>
                        </div>
                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <DropdownLink :href="route('list')"> Ваши книги </DropdownLink>
